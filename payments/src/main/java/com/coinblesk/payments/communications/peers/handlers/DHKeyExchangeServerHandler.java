 ...
 * a.decarli@papers.ch
 */
public class DHKeyExchangeServerHandler extends DHKeyExchangeHandler {
    private final static String TAG = DHKeyExchangeServerHandler.class.getSimpleName();

    public DHKeyExchangeServerHandler(InputStream inputStream, OutputStream outputStream, OnResultListener<SecretKeySpec> resultListener) {
